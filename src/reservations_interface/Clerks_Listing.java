...
public class Clerks_Listing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (room_list.getColumnModel().getColumnCount() > 0) {
            room_list.getColumnModel().getColumn(0).setPreferredWidth(204);
            room_list.getColumnModel().getColumn(1).setPreferredWidth(204);
            room_list.getColumnModel().getColumn(2).setPreferredWidth(204);
        }

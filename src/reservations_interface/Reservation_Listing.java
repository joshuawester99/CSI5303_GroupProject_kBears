...
public class Reservation_Listing extends Frame {
    ...
    public Reservation_Listing(User inputUser) {
        this.user = inputUser;

        bookings = Main.masterController.getGuestBookings(user);
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                for (Booking booking: bookings){
                    if (roomNumber.equals(booking.getRoom().getRoomNumber()) && startDate.equals(booking.getStartDate()) && endDate.equals(booking.getEndDate())){
                        ...
                        new Reservation_Display(selectedBooking);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        if (Main.masterController.checkUserInstance().equals("Clerk")){
            ...
            if (!Main.masterController.checkIfGuest(guestUsername)){
                ...
                bookings = Main.masterController.getGuestBookings(guestToSearch);
                model.setRowCount(0);
                for (Booking booking: bookings) model.addRow(new Object[] {booking.getRoom().getRoomNumber(), booking.getStartDate(), booking.getEndDate()});
            }
        }

...
public class Reservation_Display extends Frame {
    ...
    String checkInOutDisplay;

    public Reservation_Display(Booking booking) {

        this.booking = booking;

        //Determine based on booking status if button should display Check In or Check Out
        if (booking.getCheckedIn()) {
            checkInOutDisplay = "Check Out";
        } else {
            checkInOutDisplay = "Check In";
        }
        ...
        //Check if already checked out and compare check in date to current date
        if (Main.masterController.checkUserInstance().equals("Clerk") & !booking.getCheckedOut()){
            if (!booking.getCheckedIn() & booking.getStartDate().equals(LocalDate.now())){
                checkin_button.setVisible(true);
            } else if (booking.getCheckedIn()){
                checkin_button.setVisible(true);
            }
    ...
    private void initComponents() {
        ...
        checkin_button = new javax.swing.JButton();
        ...
        cancel_reservation.setFont(new java.awt.Font("Segoe UI", 0, 16));
        ...
        checkin_button.setBackground(new java.awt.Color(21, 71, 52));
        checkin_button.setFont(new java.awt.Font("Segoe UI", 0, 16));
        checkin_button.setForeground(new java.awt.Color(255, 184, 28));
        checkin_button.setText(checkInOutDisplay);
        checkin_button.setToolTipText("");
        checkin_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    checkin_buttonActionPerformed(evt);
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            }
        });
        checkin_button.setVisible(false);

        modify_reservation.setBackground(new java.awt.Color(21, 71, 52));
        modify_reservation.setFont(new java.awt.Font("Segoe UI", 0, 16));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(back_button, javax.swing.GroupLayout.Alignment.LEADING).addGap(52,52,52).addComponent(checkin_button, javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(back_button).addComponent(checkin_button)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        cancelMessageLabel.setForeground(Color.RED);
        cancelMessageLabel.setFont(customFont);
        cancelMessageLabel.setBounds(550, 460, 285, 30);
        cancelMessageLabel.setVisible(false);

        jPanel1.add(cancelMessageLabel);
        jPanel1.setComponentZOrder(cancelMessageLabel, 0);
    ...
    private void cancel_reservationActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        errorMessageLabel.setVisible(false);
        cancelMessageLabel.setVisible(false);
        if (booking.getStartDate().isBefore(LocalDate.now()) || booking.getCheckedIn()){
    ...
    // Internal for date conversions to LocalDate
    ...
    // Go back to Reservation Listing
    private void back_buttonActionPerformed(java.awt.event.ActionEvent evt) {
        new Reservation_Listing(Main.masterController.getCurrentUser());
        this.dispose();
    }

    // Check guest in if able to be checked in or out if able to be checked out
    private void checkin_buttonActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        if (!booking.getCheckedIn()){
    ...
    private void modify_reservationActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        LocalDate newStartDate = convertToLocalDate(start_date.getDate());
        LocalDate newEndDate = convertToLocalDate(end_date.getDate());
        if (modificationAvailable){
    ...
    private javax.swing.JButton checkin_button;
